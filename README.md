...
<p align="left">✨ Creating bugs since …<br>…I discovered that “it works on my machine” is not a universal truth.<br>📚 I'm currently learning …<br>How to juggle Java, AWS, React, and AI without breaking production.<br>🎯 Goals:<br>Write code that my future self won’t complain about, ship smarter systems, and keep leveling up in cloud + AI engineering.<br>🎲 Fun fact:<br>I trust version control more than my memory—and for good reason</p>
